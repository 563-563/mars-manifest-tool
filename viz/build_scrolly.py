...
NARR = {
 "2031-01": ("The Precursor",
   ...
   "One landing lights up ten capabilities at once: EDL, 840 kWe of storm-proof baseload (about 700 homes’ worth), precision landing, comms, autonomy, mobility, a habitat, and confirmed site water. That is half the program’s entire weighted risk retired on the first day anything touches down. The pilot plant even makes ~1.5 t of methalox a day and banks 483 t by 2033: not production, but hard proof the chemistry runs on Mars. And because holds don’t fly empty, the chain’s bottleneck steps ride at quantity three: at coin-flip landing odds, that nearly doubles the chance the whole chain survives intact. And two clocks start ticking that no amount of money can rush: the 1,000-sol life-support demonstration and the habitat it runs inside.",
