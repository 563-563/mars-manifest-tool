...
NARR = {
 ...
 "2039-09": ("The Town",
   ...
   "512 residents and Gen-3 closure: food, plastics and structures now come out of local dirt. The import bill per head drops from 10 to 2 tonnes per person per year and keeps sliding down a ~500× curve. But it isn’t free. Agriculture is the power monster, and grow-lighting drags the fleet to 97 ships and shoves the base past 20,600 kWe. On Mars, food is electricity wearing a costume. The electronics fab pilot lands too, at the earliest window its feedstock industry exists to supply.",
 ...
 "2041-11": ("The Settlement",
   ...
   "1,112 adults, crossing the NSS 1,000-adult settlement mark three years earlier than the conservative plan would have. About 28,400 t of hardware has landed across 322 ships, drawing 39,600 kWe, with 312 agriculture modules feeding roughly 1,248 and 91,500 m³ of pressurized volume, still sized to the honest 76.5 m³-per-person standard, not the survival floor.",
