...
| &nbsp;&nbsp;L1-RET-01 | An uncrewed Mars-surface-to-Earth return demonstration shall depart before the first crew launches and shall complete before the crew's own return flight, and pre-landed surface-hold reserves shall cover a missed return window if the demonstration fails. | Rollup | rollup | 2033-03 | CLOSED |
