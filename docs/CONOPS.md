...
and Earth supervises by exception. With water confirmed, the sintering rigs
also harden the program's one launch-grade pad at a debris-standoff site,
and the base geometry (pad, tank farm, habitat) is staked around it. Building
the pad now, after the sol-30 confirmation, is what lets the return candidate
land directly on it at window 1 so no 50 m vehicle is ever moved; the cost is
committing the base layout at the first flight and doing the pad sintering
...
supply, water *confirmed*), and the launch pad is established. Half the
program's weighted risk is retired.
...
segment as much as a fuel supply. The launch pad was already established in
window 0 (after water-confirm); this window completes the rest from assets
...
- *The tank farm is the fleet.* Banked methalox stores in the main tanks
  ...
  fly.
- *The ascent pad.* The pad is dual-rated: a landing takes a nearly-empty
  ship on a short braking burn, a launch puts full thrust into the ground for
  the whole commit. It was sintered to launch grade in window 0 at debris
...
- *Demonstrator selection.* One window-1 hull is designated the return
  ...
  Robotic survey of its Earth-entry TPS, engines, and tankage begins a full
...
**11.1 Pre-flight campaign (late 2034).** The selected hull, already standing
on the pad from its arrival landing, is fueled in place from the tank farm
over several weeks: the first ISRU propellant transfer and cryogenic
hold-through-countdown ever performed. Robots complete the TPS survey and replace suspect tiles from
