...
- **[Manifest console](https://claude.ai/code/artifact/1fa983e5-510f-401f-9820-bac33444ca7c)** — the analyst's instrument: budgets, packing, requirements buy-off, risk, ISRU, surface build-up. *(Snapshot of the pre-2026-07-14 conservative baseline — regenerate before citing.)*
- **[Surface walkthrough](https://claude.ai/code/artifact/3182378f-acac-47a3-b381-7ce2a6d36a18)** — a visual site plan of the base after each window. *(Same vintage caveat.)*
