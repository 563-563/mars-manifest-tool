...
| **2035-05** | 15 ships | **First crew.** 12 people land on ~7,400 t of banked propellant (5 return loads) with their 26-month bridge aboard — plus pilots for everything the village scales: 12 agri modules, refinery + polymer test articles, ISRU hot-spare depth, 70 robots on the surface, pad rigs for the next fleet. |
